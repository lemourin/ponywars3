...
class Edge {
	public:
        ...
        bool colidPoints(const Circle&, std::pair<Vector2d, Vector2d>& res) const; //treats edge like a line
        bool colid(const Edge&) const;
        bool colidPoint(const Edge&, Vector2d&) const; //treats both edges like lines
